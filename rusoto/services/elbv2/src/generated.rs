...
pub struct Certificate {
    ...
    /// <p>Indicates whether the certificate is the default certificate. Do not set <code>IsDefault</code> when specifying a certificate as an input parameter.</p>
...
pub struct CreateListenerInput {
    ...
    pub port: i64,
    /// <p>The protocol for connections from clients to the load balancer. For Application Load Balancers, the supported protocols are HTTP and HTTPS. For Network Load Balancers, the supported protocols are TCP and TLS.</p>
    pub protocol: String,
...
pub struct CreateTargetGroupInput {
    ...
    pub port: Option<i64>,
    /// <p>The protocol to use for routing traffic to the targets. For Application Load Balancers, the supported protocols are HTTP and HTTPS. For Network Load Balancers, the supported protocols are TCP and TLS. If the target is a Lambda function, this parameter does not apply.</p>
...
#[derive(Default, Debug, Clone, PartialEq)]
pub struct Listener {
    /// <p>The SSL server certificate. You must provide a certificate if the protocol is HTTPS or TLS.</p>
    pub certificates: Option<Vec<Certificate>>,
...
pub struct ModifyTargetGroupInput {
    ...
    pub health_check_port: Option<String>,
    /// <p>The protocol the load balancer uses when performing health checks on targets. The TCP protocol is supported for health checks only if the protocol of the target group is TCP or TLS. The TLS protocol is not supported for health checks.</p> <p>If the protocol of the target group is TCP, you can't modify this setting.</p>
    pub health_check_protocol: Option<String>,
                ...
                return response
                    ...
                    .map(|try_response| {
                        try_response.map_or_else(
                            |e| e,
                            |response| Err(AddListenerCertificatesError::from_response(response)),
                        )
                    })
                    .boxed();
            }
            ...
            if !response.status.is_success() {
                return response
                    ...
                    .map(|try_response| {
                        try_response.map_or_else(
                            |e| e,
                            |response| Err(CreateListenerError::from_response(response)),
                        )
                    })
                    .boxed();
            }
            ...
            if !response.status.is_success() {
                return response
                    ...
                    .map(|try_response| {
                        try_response.map_or_else(
                            |e| e,
                            |response| Err(CreateTargetGroupError::from_response(response)),
                        )
                    })
                    .boxed();
            }
            ...
            if !response.status.is_success() {
                return response
                    ...
                    .map(|try_response| {
                        try_response.map_or_else(
                            |e| e,
                            |response| Err(DeleteListenerError::from_response(response)),
                        )
                    })
                    .boxed();
            }
            ...
            if !response.status.is_success() {
                return response
                    ...
                    .map(|try_response| {
                        try_response.map_or_else(
                            |e| e,
                            |response| Err(DeleteTargetGroupError::from_response(response)),
                        )
                    })
                    .boxed();
            }
            ...
            if !response.status.is_success() {
                return response
                    ...
                    .map(|try_response| {
                        try_response.map_or_else(
                            |e| e,
                            |response| Err(DeregisterTargetsError::from_response(response)),
                        )
                    })
                    .boxed();
            }
            ...
            if !response.status.is_success() {
                return response
                    ...
                    .map(|try_response| {
                        try_response.map_or_else(
                            |e| e,
                            |response| Err(DescribeListenersError::from_response(response)),
                        )
                    })
                    .boxed();
            }
            ...
            if !response.status.is_success() {
                return response
                    ...
                    .map(|try_response| {
                        try_response.map_or_else(
                            |e| e,
                            |response| Err(DescribeRulesError::from_response(response)),
                        )
                    })
                    .boxed();
            }
            ...
            if !response.status.is_success() {
                return response
                    ...
                    .map(|try_response| {
                        try_response.map_or_else(
                            |e| e,
                            |response| Err(DescribeSSLPoliciesError::from_response(response)),
                        )
                    })
                    .boxed();
            }
            ...
            if !response.status.is_success() {
                return response
                    ...
                    .map(|try_response| {
                        try_response.map_or_else(
                            |e| e,
                            |response| Err(DescribeTargetGroupsError::from_response(response)),
                        )
                    })
                    .boxed();
            }
            ...
            if !response.status.is_success() {
                return response
                    ...
                    .map(|try_response| {
                        try_response.map_or_else(
                            |e| e,
                            |response| Err(DescribeTargetHealthError::from_response(response)),
                        )
                    })
                    .boxed();
            }
            ...
            if !response.status.is_success() {
                return response
                    ...
                    .map(|try_response| {
                        try_response.map_or_else(
                            |e| e,
                            |response| Err(ModifyListenerError::from_response(response)),
                        )
                    })
                    .boxed();
            }
            ...
            if !response.status.is_success() {
                return response
                    ...
                    .map(|try_response| {
                        try_response.map_or_else(
                            |e| e,
                            |response| Err(ModifyRuleError::from_response(response)),
                        )
                    })
                    .boxed();
            }
            ...
            if !response.status.is_success() {
                return response
                    ...
                    .map(|try_response| {
                        try_response.map_or_else(
                            |e| e,
                            |response| Err(ModifyTargetGroupError::from_response(response)),
                        )
                    })
                    .boxed();
            }
            ...
            if !response.status.is_success() {
                return response
                    ...
                    .map(|try_response| {
                        try_response.map_or_else(
                            |e| e,
                            |response| Err(RegisterTargetsError::from_response(response)),
                        )
                    })
                    .boxed();
            }
            ...
            if !response.status.is_success() {
                return response
                    ...
                    .map(|try_response| {
                        try_response.map_or_else(
                            |e| e,
                            |response| Err(SetIpAddressTypeError::from_response(response)),
                        )
                    })
                    .boxed();
            }
            ...
            if !response.status.is_success() {
                return response
                    ...
                    .map(|try_response| {
                        try_response.map_or_else(
                            |e| e,
                            |response| Err(SetRulePrioritiesError::from_response(response)),
                        )
                    })
                    .boxed();
            }
            ...
            if !response.status.is_success() {
                return response
                    ...
                    .map(|try_response| {
                        try_response.map_or_else(
                            |e| e,
                            |response| Err(SetSecurityGroupsError::from_response(response)),
                        )
                    })
                    .boxed();
            }
            ...
            if !response.status.is_success() {
                return response
                    ...
                    .map(|try_response| {
                        try_response.map_or_else(
                            |e| e,
                            |response| Err(SetSubnetsError::from_response(response)),
                        )
                    })
                    .boxed();
            }
